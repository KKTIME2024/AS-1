...
def register_routes(app, db):
        ...
        with app.app_context():
            ...
            for goal in goals:
                ...
                if goal.target_amount > 0:
                    progress = max(
                        0, min(
                            100, (available_savings / goal.target_amount) * 100))
    ...
    def add_expenditure():
        with app.app_context():
            ...
            # 验证类别
            valid_categories = [
                'food', 'transport', 'entertainment', 'medical',
    ...
    def goal():
        with app.app_context():
            ...
            return render_template(
                'goal.html', goals=goals_dict, overview=overview)
    ...
    def transaction():
        with app.app_context():
            ...
            expenditures_dict = [expenditure.to_dict()
                                 for expenditure in expenditures]
            # 渲染模板并传递数据
            return render_template(
                'transaction.html', incomes=incomes_dict, expenditures=expenditures_dict)
